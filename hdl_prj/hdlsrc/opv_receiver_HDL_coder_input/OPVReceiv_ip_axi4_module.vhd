-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/opv_receiver_HDL_coder_input/OPVReceiv_ip_axi4_module.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: OPVReceiv_ip_axi4_module
-- Source Path: OPVReceiv_ip/OPVReceiv_ip_axi4/OPVReceiv_ip_axi4_module
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY OPVReceiv_ip_axi4_module IS
...
END OPVReceiv_ip_axi4_module;


ARCHITECTURE rtl OF OPVReceiv_ip_axi4_module IS

  -- Component Declarations
  COMPONENT OPVReceiv_ip_rdfifo_data
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT OPVReceiv_ip_rdfifo_rid
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT OPVReceiv_ip_rdfifo_last
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : OPVReceiv_ip_rdfifo_data
    USE ENTITY work.OPVReceiv_ip_rdfifo_data(rtl);

  FOR ALL : OPVReceiv_ip_rdfifo_rid
    USE ENTITY work.OPVReceiv_ip_rdfifo_rid(rtl);

  FOR ALL : OPVReceiv_ip_rdfifo_last
    USE ENTITY work.OPVReceiv_ip_rdfifo_last(rtl);
...
BEGIN
  u_OPVReceiv_ip_rdfifo_data_inst : OPVReceiv_ip_rdfifo_data
    PORT MAP( clk => clk,
              reset => reset,
              enb => const_1,
  ...
  u_OPVReceiv_ip_rdfifo_rid_inst : OPVReceiv_ip_rdfifo_rid
    PORT MAP( clk => clk,
              reset => reset,
              enb => const_1,
  ...
  u_OPVReceiv_ip_rdfifo_last_inst : OPVReceiv_ip_rdfifo_last
    PORT MAP( clk => clk,
              reset => reset,
              enb => const_1,
