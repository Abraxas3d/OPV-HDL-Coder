-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/opv_receiver_HDL_coder_input/OPVReceiv_ip.vhd
...
ARCHITECTURE rtl OF OPVReceiv_ip IS

  -- Component Declarations
  COMPONENT OPVReceiv_ip_reset_sync
  ...
  FOR ALL : OPVReceiv_ip_reset_sync
    USE ENTITY work.OPVReceiv_ip_reset_sync(rtl);

  FOR ALL : OPVReceiv_ip_dut
    USE ENTITY work.OPVReceiv_ip_dut(rtl);

  FOR ALL : OPVReceiv_ip_axi4
    USE ENTITY work.OPVReceiv_ip_axi4(rtl);
  ...
  SIGNAL write_received_i                 : std_logic_vector(15 DOWNTO 0);  -- ufix16
  SIGNAL write_received_q                 : std_logic_vector(15 DOWNTO 0);  -- ufix16
...
BEGIN
  u_OPVReceiv_ip_reset_sync_inst : OPVReceiv_ip_reset_sync
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset_in => reset_before_sync,  -- ufix1
              reset_out => reset
              );

  u_OPVReceiv_ip_dut_inst : OPVReceiv_ip_dut
    PORT MAP( received_i => write_received_i,  -- sfix16
              received_q => write_received_q,  -- sfix16
              audio_or_data => audio_or_data_sig  -- sfix16
              );

  u_OPVReceiv_ip_axi4_inst : OPVReceiv_ip_axi4
    PORT MAP( reset => reset,
              ...
              read_audio_or_data => audio_or_data_sig,  -- sfix16
              ...
              write_received_i => write_received_i,  -- sfix16
              write_received_q => write_received_q,  -- sfix16
              reset_internal => reset_internal  -- ufix1
              );

  ip_timestamp <= unsigned'(X"8F2DBF80");
