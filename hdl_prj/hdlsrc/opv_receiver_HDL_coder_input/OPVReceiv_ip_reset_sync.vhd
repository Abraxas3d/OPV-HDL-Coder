-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/opv_receiver_HDL_coder_input/OPVReceiv_ip_reset_sync.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: OPVReceiv_ip_reset_sync
-- Source Path: OPVReceiv_ip/OPVReceiv_ip_reset_sync
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY OPVReceiv_ip_reset_sync IS
  PORT( clk                               :   IN    std_logic;
        reset_in                          :   IN    std_logic;  -- ufix1
        reset_out                         :   OUT   std_logic  -- ufix1
        );
END OPVReceiv_ip_reset_sync;


ARCHITECTURE rtl OF OPVReceiv_ip_reset_sync IS
