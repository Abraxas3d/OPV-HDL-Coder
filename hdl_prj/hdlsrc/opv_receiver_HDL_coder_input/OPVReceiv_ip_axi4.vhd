-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/opv_receiver_HDL_coder_input/OPVReceiv_ip_axi4.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: OPVReceiv_ip_axi4
-- Source Path: OPVReceiv_ip/OPVReceiv_ip_axi4
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
END OPVReceiv_ip_axi4;


ARCHITECTURE rtl OF OPVReceiv_ip_axi4 IS

  -- Component Declarations
  COMPONENT OPVReceiv_ip_addr_decoder
  ...
  COMPONENT OPVReceiv_ip_axi4_module
    PORT( clk                             :   IN    std_logic;  -- ufix1
          AXI4_ARESETN                    :   IN    std_logic;  -- ufix1
          AXI4_AWID                       :   IN    std_logic_vector(11 DOWNTO 0);  -- ufix12
          AXI4_AWADDR                     :   IN    std_logic_vector(15 DOWNTO 0);  -- ufix16
  ...
  FOR ALL : OPVReceiv_ip_addr_decoder
    USE ENTITY work.OPVReceiv_ip_addr_decoder(rtl);

  FOR ALL : OPVReceiv_ip_axi4_module
    USE ENTITY work.OPVReceiv_ip_axi4_module(rtl);
  ...
  SIGNAL write_received_i_tmp             : std_logic_vector(15 DOWNTO 0);  -- ufix16
  SIGNAL write_received_q_tmp             : std_logic_vector(15 DOWNTO 0);  -- ufix16
...
BEGIN
  u_OPVReceiv_ip_addr_decoder_inst : OPVReceiv_ip_addr_decoder
    PORT MAP( clk => AXI4_ACLK,  -- ufix1
              ...
              read_audio_or_data => read_audio_or_data,  -- sfix16
              data_read => top_data_read,  -- ufix32
              write_received_i => write_received_i_tmp,  -- sfix16
              write_received_q => write_received_q_tmp  -- sfix16
              );

  u_OPVReceiv_ip_axi4_module_inst : OPVReceiv_ip_axi4_module
    PORT MAP( clk => AXI4_ACLK,  -- ufix1
  ...
  write_received_i <= write_received_i_tmp;

  write_received_q <= write_received_q_tmp;
